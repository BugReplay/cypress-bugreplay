...
var bugreplay_automation_1 = require("bugreplay-automation");
function setupBugReplayPlugin(on, config) {
...
function setupBugReplaySupport(apiKey) {
    var _this = this;
    var testRunId = process.env.TEST_RUN_ID || new Date().toISOString();
    Cypress.on('test:before:run', function (test, instance) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bugreplay_automation_1.setup(apiKey)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, bugreplay_automation_1.startRecording()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
